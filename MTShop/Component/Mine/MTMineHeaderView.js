...
var HeaderView = React.createClass({
        ...
        return(
            <View style={styles.topViewStyle}>
                ...
                <View style={styles.centerViewStyle}>
                    <Text style={{fontSize:18, color:'white', fontWeight:'bold'}}>MT买买买</Text>
    ...
    renderBottomItem(){
        ...
        var itemArr = [];
        // 数据数组
        var data = [{'number':'100', 'title':' MT券'},{'number':'12', 'title':'评价'},{'number':'50', 'title':'收藏'}];
        // 遍历创建组件装入数组
...
const styles = StyleSheet.create({
    ...
    topViewStyle:{
        flexDirection:'row',
        marginTop:Platform.OS == 'ios'? 260: 80,
        // 设置侧轴的对齐方式
        alignItems:'center',
        // 设置主轴的对齐方式
